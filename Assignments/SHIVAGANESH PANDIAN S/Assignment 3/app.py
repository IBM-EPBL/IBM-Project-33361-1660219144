...
COS_API_KEY_ID="iS4qEM-Wdn1y4-_-xobpM50sHNqeToA7gHsKqlXzTXVx",
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/b3716c4d5d72491e83947fa4c52340f8:6bcbb319-6ac2-46e0-82bc-049256c0eeb4:bucket:bucket-assignment3"
...
@app.route('/')
def index():
    files = get_bucket_contents('bucket-assignment3')
